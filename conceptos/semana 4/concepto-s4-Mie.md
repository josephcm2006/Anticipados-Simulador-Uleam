...
TEMA - Oración, (La oración es la unidad mínima de comunicación lingüística con sentido completo, independencia sintáctica y una curva de entonación determinada. Sintácticamente, se caracteriza por presentar por lo menos un verbo conjugado que funciona como el núcleo del predicado, entablando una relación de concordancia obligatoria en número y persona con el núcleo del sujeto.
